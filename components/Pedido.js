...
const Pedido = ({ pedido }) => {
    ...
    //Funcion que modiica que color del pedido de acuerdo a su estado
    const clasePedido = () => {
    ...
    return (
        <div className={ `${ clase } border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:gap-4 shadow-lg` }>
            <div>
                ...
                <select
                    className="mt-2 appearance-none bg-blue-600 border border-blue-600 p-2 text-white rounded leading-tight focus:outline-none focus: bg-blue-800 focus:border-blue-500 uppercase text-xs"
                    value={ estadoPedido }
            ...
            <div>
                <h2 className="text-gray-800">Reumen del Pedido</h2>
                ...
                <button
                    className="flex items-center bt-4 bg-red-800 px-5 py-2 inline-block text-white rounded leading-tight uppercase text-xs font-bold"
